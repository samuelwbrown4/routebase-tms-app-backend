const { getAllOrdersService, getOrderLineItemsService, getOrdersByStatusService, createOrderService, getOrdersByDateRangeService } = require('../services/orders.service.js')
...
const getOrdersByDateRange = async (req, res) => {
    try {
        ...
        const orders = await getOrdersByDateRangeService(shipperLocationId)
